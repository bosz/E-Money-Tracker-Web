    ...
    <AdminLayout pageTitle="Home">
      <div className="container-fluid">
          <h1 className="title text-center">
            Welcome to the e-money tracker
          </h1>
            ...
            <Row>
              ...
              <Col sm="12" md="4" lg="4">
                <Card>
                  ...
                  <CardBody>
                    ...
                    <Button className="btn-block">Submit <i className="fa fa-plus-circle"></i></Button>
                  </CardBody>
              ...
              <Card>
                  ...
                  <CardBody>
                    ...
                    <div>
                      <a href="https://designrevision.com/docs/shards-react/getting-started">You can get help here</a>
                    </div>
